        ...
        React.createElement("div", {style: AutoPrefix.all(styles.dateContainer)}, 
          React.createElement("div", {style: AutoPrefix.all(styles.date)}, 
            ...
            React.createElement(SlideInTransitionGroup, {
              ...
              direction: this.state.transitionDirection}, 
              React.createElement("div", {key: month, style: styles.month.title, onClick: this._handleMonthDayClick}, month)
            ), 

            React.createElement(SlideInTransitionGroup, {
              style: styles.day.root, 
              direction: this.state.transitionDirection}, 
              React.createElement("div", {key: day, style: styles.day.title, onClick: this._handleMonthDayClick}, day)
            ), 

            React.createElement(SlideInTransitionGroup, {
              style: styles.year.root, 
              direction: this.state.transitionDirection}, 
              React.createElement("div", {key: year, style: styles.year.title, onClick: this._handleYearClick}, year)
            )
          )
